...
def main():
    ...
    #
    model_path = "/opt/scripts/whisper_example/whisper-tiny-int8/"
    whisper_model = WhisperModel(model_path, device="cuda", compute_type="int8")
    #
    # model_path = "/opt/scripts/whisper_example/whisper-small-float16/"
    # whisper_model = WhisperModel(model_path, device="cuda", compute_type="float16")
    #
    # model_path = "/opt/scripts/whisper_example/whisper-small-int8/"
    # whisper_model = WhisperModel(model_path, device="cuda", compute_type="int8")
